...
#undef dout_prefix
#define dout_prefix                                                            \
  *_dout << "librbd::io::QosImageDispatch: " << this << " " << __func__ << ": "
...
QosImageDispatch<I>::QosImageDispatch(I *image_ctx)
  ...
  for (auto flag : throttle_flags) {
    m_throttles.push_back(
        make_pair(flag.first, new TokenBucketThrottle(cct, flag.second, 0, 0,
                                                      timer, timer_lock)));
  }
}

template <typename I> QosImageDispatch<I>::~QosImageDispatch() {
...
template <typename I> void QosImageDispatch<I>::shut_down(Context *on_finish) {
...
template <typename I>
bool QosImageDispatch<I>::read(AioCompletion *aio_comp, Extents &&image_extents,
...
template <typename I>
bool QosImageDispatch<I>::write(AioCompletion *aio_comp,
...
template <typename I>
bool QosImageDispatch<I>::discard(AioCompletion *aio_comp,
...
template <typename I>
bool QosImageDispatch<I>::flush(AioCompletion *aio_comp,
