...
#undef dout_prefix
#define dout_prefix                                                            \
  *_dout << "librbd::io::ImageDispatch: " << this << " " << __func__ << ": "
...
template <typename I>
bool ImageDispatch<I>::read(AioCompletion *aio_comp, Extents &&image_extents,
...
template <typename I>
bool ImageDispatch<I>::write(AioCompletion *aio_comp, Extents &&image_extents,
...
template <typename I>
bool ImageDispatch<I>::discard(AioCompletion *aio_comp, Extents &&image_extents,
...
template <typename I>
bool ImageDispatch<I>::write_same(AioCompletion *aio_comp,
...
template <typename I>
bool ImageDispatch<I>::flush(AioCompletion *aio_comp, FlushSource flush_source,
                             const ZTracer::Trace &parent_trace, uint64_t tid,
                             std::atomic<uint32_t> *image_dispatch_flags,
                             DispatchResult *dispatch_result,
                             Context **on_finish, Context *on_dispatched) {
...
template <typename I>
bool ImageDispatch<I>::list_snaps(AioCompletion *aio_comp,
                                  Extents &&image_extents, SnapIds &&snap_ids,
